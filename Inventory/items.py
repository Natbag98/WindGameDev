...
class ReinforcedPlank(Item):

    def __init__(self, game):
        super().__init__(game, _inventory_items['ReinforcedPlank'])


class Boat(Item):

    def __init__(self, game):
        super().__init__(game, _inventory_items['Boat'])


class Sails(Item):

    def __init__(self, game):
        super().__init__(game, _inventory_items['Sails'])
